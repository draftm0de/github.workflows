...
- [`node-js-test`](.github/actions/node-js-test/README.md) — Installs dependencies, runs lint/Prettier/badge npm scripts, and executes the Node test suite while emitting GitHub summary checklists.
