...
## Inputs
- `package-json-path` (optional): Path to the `package.json` file. Defaults to `package.json` at the repo root.

## Outputs
- `version`: Bare semver version (x.y.z) read from `package.json`.
